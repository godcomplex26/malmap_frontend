...
<div class="container mt-10 mx-auto">
  <div class="flex-col gap-4 sm:grid sm:grid-cols-8 min-w-[600px] sm:grid-rows-12 sm:min-w-[908px]">
    <div class="mb-8 sm:mb-0 p-4 bg-gray-200 flex col-span-8 row-span-6 max-h-[632px] sm:col-span-6 sm:row-span-12 min-w-[600px]">
    ...
    <div class="flex-cols mb-8 sm:mb-0 bg-gray-200 p-4 col-span-8 row-span-3 max-h-96 sm:col-span-2 sm:row-span-6 sm:max-h-[308px] sm:min-w-[308px] overflow-y-auto">
      <div class="flex pb-3">
    ...
    <div id="chart" class="flex items-center max-h-96 bg-gray-200 p-4 sm:col-span-2 sm:row-span-6 sm:max-h-[308px] sm:min-w-[308px]" bind:clientWidth={w} bind:clientHeight={h}>
      {#if activeChart === 0}
